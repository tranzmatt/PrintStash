...
const SUITES = [
  {
    ...
    total: { statements: 82.0, branches: 76.2 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 93.1, branches: 84.6 },
      ...
      { prefix: "src/components/", statements: 78.5, branches: 74.3 },
      ...
      { prefix: "src/pages/", statements: 87.5, branches: 79.4 },

...
const ES_PHRASES: ReadonlyArray<readonly [string, string]> = [
  ...
  ["Usage includes known sizes only.", "El uso solo incluye tamaños conocidos."],
  [
    "objects have no recorded size. Provider totals:",
    "objetos no tienen un tamaño registrado. Totales del proveedor:",
  ],
  ["Last saved measurement:", "Última medición guardada:"],
  ["Free:", "Libre:"],
  ["· Reserved:", "· Reservado:"],
  ["· Headroom:", "· Margen:"],
  ["Recorded owned storage over time", "Almacenamiento propio registrado a lo largo del tiempo"],
  ["maximum", "máximo"],
  [
    "daily measurements retained. Forecasts do not authorize writes.",
    "mediciones diarias conservadas. Las previsiones no autorizan escrituras.",
  ],

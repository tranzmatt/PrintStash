...
const messages = {
  en: {
    ...
    "auditSchedule.fullCost":
      "I understand Full audits read all owned data, including backups, and may incur remote transfer costs.",
    ...
    "auditSchedule.quick": "Quick audit",
    "auditSchedule.full": "Full audit",
    "auditSchedule.saveFailed":
      "Could not save audit schedule. Check the timezone and limits, then retry.",
    "auditSchedule.skipFailed": "Could not skip the next audit. Please retry.",
    "auditSchedule.schedule": "schedule",
    "auditSchedule.enabled": "Enabled",
    "auditSchedule.paused": "Paused",
    "auditSchedule.timezone": "Timezone",
    "auditSchedule.windowStart": "Window starts",
    "auditSchedule.windowLength": "Window length (minutes)",
    "auditSchedule.weekday": "Weekday (Monday 0, Sunday 6)",
    "auditSchedule.monthDay": "Day of month",
    "auditSchedule.bandwidth": "Maximum read bytes per second",
    "auditSchedule.autoRepair":
      "Automatically rebuild selected derived data after verifying its source",
    "auditSchedule.metadata": "Missing Metadata",
    "auditSchedule.thumbnails": "Missing or unreadable thumbnails",
    "auditSchedule.nextDue": "Next due",
    "auditSchedule.lastSuccess": "Last success",
    "auditSchedule.deferred": "Deferred",
    "auditSchedule.save": "Save schedule",
    "auditSchedule.skip": "Skip next audit",
    "auditSchedule.title": "Scheduled audits",
    "auditSchedule.loadFailed": "Could not load audit schedules.",
    "auditSchedule.retry": "Retry",
    "auditSchedule.loading": "Loading schedules…",
    "auditSchedule.history": "Audit history",
    "auditSchedule.empty": "No audit runs yet.",
    "auditSchedule.critical": "critical",
    "auditSchedule.warnings": "warnings",
    ...
    "build.objects": "Number of objects",
    "build.snapshotHelp":
      "This saves a copy of the pieces and quantities. Later composition changes do not alter this build.",
    "build.showArchived": "Show archived builds",
    "build.refresh": "Refresh",
    "build.empty": "No builds here yet. Open a multipart model to create one.",
    "build.complete": "All required pieces confirmed",
    "build.inProgress": "Pieces still needed",
    "build.previous": "Previous",
    "build.next": "Next",
    "build.loading": "Loading build…",
    "build.objectCount": "{count} objects",
    "build.archived": "Archived build",
    "build.resultHelp":
      "A finished job proposes a result. Confirm how many pieces are usable; only confirmed pieces reduce what is missing.",
    "build.copyName": "Name for the new build",
    "build.duplicate": "Duplicate build",
    "build.duplicateHelp":
      "The new build keeps the selected pieces and revisions and starts with no print results.",
    "build.archive": "Archive history",
    "build.unarchive": "Restore from archive",
    "build.missing": "{count} missing",
    "build.required": "Required",
    "build.valid": "Confirmed usable",
    "build.active": "In active jobs",
    "build.unreviewed": "Awaiting confirmation",
    "build.choice": "Model Choice",
    "build.unavailable": "Unavailable",
    "build.revision": "Revision for the next jobs",
    "build.noRevision": "Select a Revision",
    "build.revisionHelp":
      "A recommendation is only a starting choice. Changing this selection affects future jobs; earlier attempts keep their original Revision.",
    "build.unitsPerFile": "Pieces produced by this file",
    "build.jobs": "Print jobs to queue",
    "build.printer": "Printer",
    "build.automatic": "Automatic routing",
    "build.choosePrinter": "Select a printer",
    "build.excess": "I confirm {count} extra pieces beyond the unreserved requirement.",
    "build.queue": "Queue pieces",
    "build.history": "Print attempts",
    "build.attempt": "Job #{id}",
    "build.planned": "{count} planned pieces",
    "build.confirm": "Confirm result",
    "build.correct": "Correct result",
    "build.jobCompleted": "Completed",
    "build.jobFailed": "Failed",
    "build.jobCancelled": "Cancelled",
    "build.jobActive": "Active",
    "build.quantity": "Units per object",
    "build.conflict": "This build changed. Refresh it before confirming another action.",
    "build.denied": "You do not have permission for this action.",
    "build.revisionRequired": "Select an available G-code Revision before queuing this piece.",
    "build.excessRequired": "Review and confirm the extra pieces before queuing.",
    "build.batchLimit": "This exceeds the queue limit. Queue fewer jobs at a time.",
    "build.failed": "The action could not be completed. Refresh the build and try again.",
    ...
    "settings.backupAutomaticEnableDescription":
      "Create one backup every day at the UTC time below.",
    "settings.backupAutomaticTime": "Daily time (UTC)",
    "settings.backupDestination": "Destination",
    ...
    "settings.backupUseManual": "Use {name} for manual backups",
  ...
  es: {
    ...
    "auditSchedule.fullCost":
      "Entiendo que las auditorías completas leen todos los datos, incluidas las copias de seguridad, y pueden generar costes de transferencia.",
    "auditSchedule.description":
      "Activa comprobaciones rápidas semanales o completas mensuales. Las ejecuciones pendientes se recuperan una vez dentro de la próxima ventana diaria. Se realiza una lectura a la vez.",
    "auditSchedule.quick": "Auditoría rápida",
    "auditSchedule.full": "Auditoría completa",
    "auditSchedule.saveFailed":
      "No se pudo guardar la programación. Comprueba la zona horaria y los límites e inténtalo de nuevo.",
    "auditSchedule.skipFailed": "No se pudo omitir la próxima auditoría. Inténtalo de nuevo.",
    "auditSchedule.schedule": "programación",
    "auditSchedule.enabled": "Activada",
    "auditSchedule.paused": "En pausa",
    "auditSchedule.timezone": "Zona horaria",
    "auditSchedule.windowStart": "Inicio de la ventana",
    "auditSchedule.windowLength": "Duración de la ventana (minutos)",
    "auditSchedule.weekday": "Día de la semana (lunes 0, domingo 6)",
    "auditSchedule.monthDay": "Día del mes",
    "auditSchedule.bandwidth": "Máximo de bytes leídos por segundo",
    "auditSchedule.autoRepair":
      "Reconstruir los datos derivados seleccionados tras verificar su origen",
    "auditSchedule.metadata": "Metadatos ausentes",
    "auditSchedule.thumbnails": "Miniaturas ausentes o ilegibles",
    "auditSchedule.nextDue": "Próxima ejecución",
    "auditSchedule.lastSuccess": "Última ejecución correcta",
    "auditSchedule.deferred": "Aplazada",
    "auditSchedule.save": "Guardar programación",
    "auditSchedule.skip": "Omitir próxima auditoría",
    "auditSchedule.title": "Auditorías programadas",
    "auditSchedule.loadFailed": "No se pudieron cargar las programaciones.",
    "auditSchedule.retry": "Reintentar",
    "auditSchedule.loading": "Cargando programaciones…",
    "auditSchedule.history": "Historial de auditorías",
    "auditSchedule.empty": "Todavía no hay auditorías.",
    "auditSchedule.critical": "críticos",
    "auditSchedule.warnings": "advertencias",
    ...
    "build.help":
      "Sigue las piezas necesarias para un objeto multipieza, incluidos los fallos y las reposiciones.",
    "build.create": "Crear fabricación",
    "build.name": "Nombre de la fabricación",
    "build.objects": "Cantidad de objetos",
    "build.snapshotHelp":
      "Se guarda una copia de las piezas y cantidades. Los cambios posteriores en la composición no alteran esta fabricación.",
    "build.showArchived": "Mostrar fabricaciones archivadas",
    "build.refresh": "Actualizar",
    "build.empty": "Todavía no hay fabricaciones aquí. Abre un modelo multipieza para crear una.",
    "build.complete": "Todas las piezas necesarias están confirmadas",
    "build.inProgress": "Quedan piezas pendientes",
    "build.previous": "Anterior",
    "build.next": "Siguiente",
    "build.loading": "Cargando fabricación…",
    "build.objectCount": "{count} objetos",
    "build.archived": "Fabricación archivada",
    "build.resultHelp":
      "Un trabajo finalizado propone un resultado. Confirma cuántas piezas son válidas: solo las confirmadas reducen los faltantes.",
    "build.copyName": "Nombre de la nueva fabricación",
    "build.duplicate": "Duplicar fabricación",
    "build.duplicateHelp":
      "La nueva fabricación conserva las piezas y revisiones elegidas y empieza sin resultados de impresión.",
    "build.archive": "Archivar historial",
    "build.unarchive": "Recuperar del archivo",
    "build.missing": "Faltan {count}",
    "build.required": "Necesarias",
    "build.valid": "Válidas confirmadas",
    "build.active": "En trabajos activos",
    "build.unreviewed": "Pendientes de confirmar",
    "build.choice": "Opción de modelo",
    "build.unavailable": "No disponible",
    "build.revision": "Revisión para los próximos trabajos",
    "build.noRevision": "Selecciona una revisión",
    "build.revisionHelp":
      "La recomendación es una selección inicial. Cambiarla afecta a los próximos trabajos; los intentos anteriores conservan su revisión.",
    "build.unitsPerFile": "Piezas que produce este archivo",
    "build.jobs": "Trabajos que encolar",
    "build.printer": "Impresora",
    "build.automatic": "Asignación automática",
    "build.choosePrinter": "Selecciona una impresora",
    "build.excess": "Confirmo {count} piezas adicionales a las necesarias sin reservar.",
    "build.queue": "Encolar piezas",
    "build.history": "Intentos de impresión",
    "build.attempt": "Trabajo n.º {id}",
    "build.planned": "{count} piezas previstas",
    "build.confirm": "Confirmar resultado",
    "build.correct": "Corregir resultado",
    "build.jobCompleted": "Completado",
    "build.jobFailed": "Fallido",
    "build.jobCancelled": "Cancelado",
    "build.jobActive": "Activo",
    "build.quantity": "Unidades por objeto",
    "build.conflict": "Esta fabricación ha cambiado. Actualízala antes de confirmar otra acción.",
    "build.denied": "No tienes permiso para esta acción.",
    "build.revisionRequired":
      "Selecciona una revisión G-code disponible antes de encolar esta pieza.",
    "build.excessRequired": "Revisa y confirma las piezas adicionales antes de encolar.",
    "build.batchLimit": "Se supera el límite de la cola. Encola menos trabajos cada vez.",
    "build.failed":
      "No se ha podido completar la acción. Actualiza la fabricación y vuelve a intentarlo.",
    ...
    "settings.backupAutomaticEnableDescription":
      "Crea una copia cada día a la hora UTC indicada abajo.",
    "settings.backupAutomaticTime": "Hora diaria (UTC)",
    "settings.backupDestination": "Destino",
    "settings.backupManualColumn": "Manual",
    ...
    "settings.backupUseManual": "Usar {name} para copias manuales",

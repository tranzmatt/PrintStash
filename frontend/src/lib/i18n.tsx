...
const messages = {
  en: {
    "auditSchedule.1": "Quick audit",
    "auditSchedule.2": "Full audit",
    "auditSchedule.3": "Could not save audit schedule. Check the timezone and limits, then retry.",
    "auditSchedule.4": "Could not skip the next audit. Please retry.",
    "auditSchedule.5": "schedule",
    "auditSchedule.6": "Enabled",
    "auditSchedule.7": "Paused",
    "auditSchedule.8": "Timezone",
    "auditSchedule.9": "Window starts",
    "auditSchedule.10": "Window length (minutes)",
    "auditSchedule.11": "Weekday (Monday 0, Sunday 6)",
    "auditSchedule.12": "Day of month",
    "auditSchedule.13": "Maximum read bytes per second",
    "auditSchedule.14": "Automatically rebuild selected derived data after verifying its source",
    "auditSchedule.15": "Missing Metadata",
    "auditSchedule.16": "Missing or unreadable thumbnails",
    "auditSchedule.17": "Next due",
    "auditSchedule.18": "Last success",
    "auditSchedule.19": "Deferred",
    "auditSchedule.20": "Save schedule",
    "auditSchedule.21": "Skip next audit",
    "auditSchedule.22": "Scheduled audits",
    "auditSchedule.23": "Could not load audit schedules.",
    "auditSchedule.24": "Retry",
    "auditSchedule.25": "Loading schedules…",
    "auditSchedule.26": "Audit history",
    "auditSchedule.27": "No audit runs yet.",
    "auditSchedule.28": "critical",
    "auditSchedule.29": "warnings",

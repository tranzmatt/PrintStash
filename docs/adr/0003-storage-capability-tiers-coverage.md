...
|---:|---|---|---|:---:|
| 1 | Derive tier from capability axes | Unit | `unit/modules/storage/test_storage_backend.py` | ✅ |
| 2 | Render warnings for absent safety axes | Unit | `unit/modules/storage/test_storage_backend.py` | ✅ |
| 3 | Probe local roots as Verified | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
| 4 | Downgrade a hardlink failure | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
| 5 | Distrust network inode identity | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
| 6 | Report directory-fsync failure diagnostically | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
| 7 | Choose weaker local-root result | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
| 8 | Derive S3 tier from versioning | Integration | `integration/modules/storage/test_storage_backend.py` | ✅ |
...
| 27 | Fail when S3 bucket is absent | Contract | `contract/modules/storage/test_storage_backend.py` | ✅ |
| 28 | Never create an S3 bucket | Contract | `contract/modules/storage/test_storage_backend.py` | ✅ |
| 29 | Never change S3 lifecycle policy | Contract | `contract/modules/storage/test_storage_backend.py` | ✅ |
| 30 | Retain destructive lifecycle findings | Contract | `contract/modules/storage/test_storage_backend.py` | ✅ |
| 31 | Preserve backup S3 behaviour | Contract | `contract/modules/backups/backup/test_s3.py` | ✅ |
...
| 37 | Skip scheduled non-Verified purge | Integration | `integration/modules/storage/test_storage_deletion.py` | ✅ |
...
| 40 | Serve provider metadata during setup | Integration | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 41 | Resolve named S3 presets | Unit | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 42 | Resolve Nextcloud WebDAV path | Unit | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 43 | Reject invalid provider roots | Unit | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 44 | Reject invalid SFTP authentication | Unit | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 45 | Apply configuration precedence | Integration | `integration/modules/administration/runtime_config/test_runtime_config.py` | ✅ |
...
| 49 | Report optional transports unavailable | Unit | `integration/modules/storage/test_storage_providers.py` | ✅ |
| 50 | Persist provider setup end to end | Playwright real | `e2e-real/storage/storage-provider.spec.ts` | ✅ |
| 51 | Stream WebDAV create/read round trip | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |
| 52 | Stream SFTP password round trip | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |
| 53 | Stream SFTP mounted-key round trip | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |
| 54 | Remove failed remote temporary key | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |
| 55 | Record post-write remote evidence | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |
| 56 | Fail closed for remote verified mutation | Contract | `contract/modules/storage/test_storage_opendal.py` | ✅ |

...
from app.modules.ingestion.capture_provider_transport import ProviderTransport
...
def _invalidate_provider_metadata_cache(
    ...
    try:
        from app.modules.ingestion.provider_metadata_cache import (
            invalidate_provider_metadata_cache,
        )

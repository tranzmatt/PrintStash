...
from app.modules.storage.remote_io import (
    IdentityDeletion,
    ManagedCreation,
    RemoteCapabilities,
    RemoteEntry,
...
from app.modules.storage.storage_identity import (
...
class _RemoteAdapter:
    ...
    def _webdav_listing(self, directory: str):
        from app.modules.storage.webdav_listing import iter_webdav_directory

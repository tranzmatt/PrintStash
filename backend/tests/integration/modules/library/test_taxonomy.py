...
from app.modules.library.taxonomy import parse_tag_input
...
class TestResolveTags:
    def test_resolve_creates_new_tags(self, db_session) -> None:
        from app.modules.library.taxonomy import resolve_or_create_tags
...
class TestResolveCollections:
    def test_resolve_creates_hierarchy(self, db_session) -> None:
        from app.modules.library.taxonomy import resolve_or_create_collection
...
class TestResolveCollectionInTransaction:
    def test_creates_hierarchy_without_committing(self, db_session) -> None:
        from app.modules.library.taxonomy import (
            resolve_or_create_collection_in_transaction,
        )
...
class TestResolveTagsInTransaction:
    def test_creates_each_name_once(self, db_session) -> None:
        from app.modules.library.taxonomy import resolve_or_create_tags_in_transaction
...
class TestListTagsService:
    def test_list_tags_service(self, db_session) -> None:
        from app.modules.library.taxonomy import list_tags, resolve_or_create_tags

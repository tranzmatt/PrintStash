...
from app.modules.printing.filament import mm_to_grams
from app.modules.printing.filament_sync import cost_per_kg_from_filament
...
def _sync(session: Session, filaments):
    with patch("app.modules.printing.filament_sync.get_spoolman_client") as mock_get:
